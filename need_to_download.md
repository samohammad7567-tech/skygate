...
## 2. Deliberately not taken from the export
...
## 4. Photography the API is expected to publish
...
## 5. Fields `my-trips` does not send yet
...
## 6. Endpoints in the collection with no caller
