...
/// The body `GET app/payment-methods` really answers with — the rows sit under
/// `data.items`, `instructions` is one CRLF-separated block, and `image` is a
...
void main() {
  ...
  test('brands a method only when its name says so', () {
    ...
    // The rows that used to be stamped with a transfer company's mark.
