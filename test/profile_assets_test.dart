...
void main() {
  ...
  /// A status the mapper does not recognise must never chip a file as
  /// "موثقة" — the pilgrim would stop chasing a document still in review.
  ...
  /// `PilgrimDocumentResource.status` is typed as an array of strings but
  /// arrives as a plain string just as often.
  ...
  /// The upload is keyed by a numeric id the design's catalogue does not
  /// carry, so the slug match is what ties the two together.
