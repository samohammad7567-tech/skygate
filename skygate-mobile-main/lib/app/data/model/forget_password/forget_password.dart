...
class ForgetPasswordModel with FormzMixin {
  ...
  factory ForgetPasswordModel.fromJson(Map<String, dynamic> json) {
    return ForgetPasswordModel(
      cardNumber:
          RequiredField.fromJson(json[_ForgetPasswordKeys.cardNumber] ?? ''),
      dob: RequiredField.fromJson(json[_ForgetPasswordKeys.dob] ?? ''),
      mobileNumber:
          PhoneNumberField.fromJson(json[_ForgetPasswordKeys.mobileNumber] ?? ''),
    );
  }
  ...
  ForgetPasswordModel copyWith({cardNumber, dob, mobileNumber}) {
    return ForgetPasswordModel(
