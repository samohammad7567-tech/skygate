...
import 'package:sky_gate/app/global_widgets/custom_alert_dialog.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          // Fingerprint Setup
          Visibility(
            visible: (SharedClass.biometricsEnabled == "0" ||
          ...
          Visibility(
              visible: (SharedClass.biometricsEnabled == "false" ||
                  SharedClass.biometricsEnabled == ""),
