...
import 'package:sky_gate/app/global_widgets/date_picker_form_field.dart';
...
import 'package:sky_gate/app/global_widgets/time_picker_form_field.dart';
                ...
                GetBuilder<AirportTaxiController>(
                  ...
                  builder: (airportTaxiController) {
                    if (airportTaxiController
                      ...
                      if (airportTaxiController
                          .airportTaxiRequestsList.isEmpty) {
                        // Form to contain all text fields
                        return Form(
                          key: _formKey,
                          child: Column(
                            children: [
