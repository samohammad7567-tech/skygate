class ChangeRequestModel {
  ...
  ChangeRequestModel({this.id, this.user_id, this.booking_request_number,
    this.change_type, this.first_way_trip_id, this.return_trip_id,
    this.change_penalty, this.cost_difference, this.plane_missing_penalty,
    this.currency, this.status, this.created_at, this.updated_at,
    this.payment_method,this.is_paid});
