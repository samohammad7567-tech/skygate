...
import 'package:sky_gate/app/modules/my-trips-agenda/views/widgets/horizontal_day_selector.dart';
import 'package:sky_gate/app/modules/my-trips-agenda/views/widgets/trip_card.dart';
                            ...
                            onTap: () {
                              myTripsAgendaController.selectSecondWayTrip(
                                ...
                                tripID: myTripsAgendaController
                                    .secondWayTripsFiltered[index].id,
                              );
                            },
                            child: TripCard(
                              ...
                              arrivalCity: myTripsAgendaController
                                  .secondWayTripsFiltered[index].arrival_city,
                              arrivalTime: myTripsAgendaController
                                  .secondWayTripsFiltered[index].arrival_time,
                              departureAirport: myTripsAgendaController
                                  .secondWayTripsFiltered[index]
                                  .departure_airport,
                              departureCity: myTripsAgendaController
                                  .secondWayTripsFiltered[index].departure_city,
                              departureTime: myTripsAgendaController
                                  .secondWayTripsFiltered[index].departure_time,
                              ...
                              tripDuration: myTripsAgendaController
                                  .secondWayTripsFiltered[index].trip_duration,
                              tripNumber: myTripsAgendaController
                                  .secondWayTripsFiltered[index].trip_number,
