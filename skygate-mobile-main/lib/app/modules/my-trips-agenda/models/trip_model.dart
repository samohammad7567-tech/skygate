...
import 'package:sky_gate/app/modules/my-trips-agenda/models/flight_company_model.dart';
...
class TripModel {
  ...
  TripModel({this.id, this.flight_company, this.departure_city, this.arrival_city,
    this.departure_airport, this.arrival_airport, this.departure_time,
    this.repeat_start_date,this.repeat_end_date,this.repeat_days,
    this.arrival_time, this.departure_date, this.trip_duration, this.first_way_level,
    this.second_way_level,this.first_transit_city,this.first_transit_airport,
    this.second_transit_city, this.second_transit_airport,
    this.one_way_adult_cost_dollar, this.one_way_child_cost_dollar,
    this.one_way_baby_cost_dollar, this.one_way_adult_cost_syp, this.one_way_child_cost_syp,
    this.one_way_baby_cost_syp, this.two_way_adult_cost_dollar, this.two_way_child_cost_dollar,
    this.two_way_baby_cost_dollar, this.two_way_adult_cost_syp, this.two_way_child_cost_syp,
    this.two_way_baby_cost_syp, this.trip_number, this.one_way_business_adult_cost_dollar, this.one_way_business_child_cost_dollar,
    this.one_way_business_baby_cost_dollar, this.one_way_business_adult_cost_syp, this.one_way_business_child_cost_syp,
    this.one_way_business_baby_cost_syp, this.two_way_business_adult_cost_dollar, this.two_way_business_child_cost_dollar,
    this.two_way_business_baby_cost_dollar, this.two_way_business_adult_cost_syp, this.two_way_business_child_cost_syp,
    this.two_way_business_baby_cost_syp, this.created_at, this.updated_at});

  factory TripModel.fromJson(Map<String, dynamic> json) {
    List<String> days = [];
    if(json["repeat_days"] != null) {
      final repeat_days = jsonDecode(json["repeat_days"]);
      repeat_days.forEach((element) {
          days.add(element);
      });
    }
    return TripModel(
        id : json["id"] ?? -1,
        flight_company :(json["flight_company"] != null)? FlightCompanyModel.fromJson(json["flight_company"]):FlightCompanyModel(),
        ...
        one_way_business_adult_cost_dollar: json["one_way_business_adult_cost_dollar"] ?? "0",
        one_way_business_child_cost_dollar: json["one_way_business_child_cost_dollar"] ?? "0",
        one_way_business_baby_cost_dollar: json["one_way_business_baby_cost_dollar"] ?? "0",
        one_way_business_adult_cost_syp: json["one_way_business_adult_cost_syp"] ?? "0",
        one_way_business_child_cost_syp: json["one_way_business_child_cost_syp"] ?? "0",
        one_way_business_baby_cost_syp: json["one_way_business_baby_cost_syp"] ?? "0",
        two_way_business_adult_cost_dollar: json["two_way_business_adult_cost_dollar"] ?? "0",
        two_way_business_child_cost_dollar: json["two_way_business_child_cost_dollar"] ?? "0",
        two_way_business_baby_cost_dollar: json["two_way_business_baby_cost_dollar"] ?? "0",
        two_way_business_adult_cost_syp: json["two_way_business_adult_cost_syp"] ?? "0",
        two_way_business_child_cost_syp: json["two_way_business_child_cost_syp"] ?? "0",
        two_way_business_baby_cost_syp: json["two_way_business_baby_cost_syp"] ?? "0",
