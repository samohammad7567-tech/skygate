...
import 'package:sky_gate/app/modules/travel-allowed-countries/models/travel_allowed_country_model.dart';
import 'package:sky_gate/app/modules/travel-allowed-countries/repository/get_travel_allowed_countries_repository.dart';
...
class TravelAllowedCountriesController extends GetxController {
  ...
  GetTravelAllowedCountriesDataStatus getTravelAllowedCountriesDataStatus = GetTravelAllowedCountriesDataStatus.initial;
  ...
  Future<void> getTravelAllowedCountriesData() async {
    getTravelAllowedCountriesDataStatus = GetTravelAllowedCountriesDataStatus.loading;
    update();

    (await getTravelAllowedCountriesRepository.getTravelAllowedCountries())
        .fold((left) {
      getTravelAllowedCountriesDataStatus = GetTravelAllowedCountriesDataStatus.error;
      update();
    }, (right) async {
      if(right.code == "1") {
        travelAllowedCountriesList = right.data!;
        travelAllowedCountriesList.forEach((element) {
        ...
        getTravelAllowedCountriesDataStatus = GetTravelAllowedCountriesDataStatus.success;
        update();
      } else {
