...
class SignUpModel with FormzMixin {
  ...
  SignUpModel copyWith({String? memberCard, String? phoneNumber,String? password,String? confirmPassword,String? memberName,String? dob}) {
    return SignUpModel(
        memberCard: RequiredField.dirty(memberCard ?? this.memberCard.value),
        phoneNumber: PhoneNumberField.dirty(phoneNumber ?? this.phoneNumber.value),
        password: PasswordField.dirty(password ?? this.password.value),
        confirmPassword: ConfirmPasswordField.dirty(confirmPassword ?? this.confirmPassword.value, originPassword: password ?? this.password.value),
  ...
  @override
  List<FormzInput> get inputs => [memberCard,phoneNumber, password,memberName,dob];
