...
Future<void> _showNotification(
  ...
  androidPlatformChannelSpecifics = AndroidNotificationDetails(
    PushNotificationRepository.channelId,
...
class NotificationHandler {
  void listenForReceivedNotification() {
    ...
    repository.receivedNotificationStreamController.stream.listen((
      ReceivedPushNotification event,
    ) {
  ...
  void listenForSelectedNotification() {
    PushNotificationRepository repository =
        Get.find<PushNotificationRepository>();
    repository.selectedNotificationStreamController.stream.listen((
      SelectedPushNotification event,
    ) {
