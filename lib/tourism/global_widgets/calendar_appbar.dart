...
class _CalendarAppBarState extends State<CalendarAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    pastDates.sort((b, a) => b.compareTo(a));
    Widget calendarView() {
      return Container(
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          Positioned(bottom: 0.0, child: calendarView()),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 12.0,
          fontWeight: FontWeight.w400,
          color: widget.black!.withValues(alpha: 0.8),
        ),
      ),
    );
  }
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: outOfRange
                      ? isSelectedDate
                            ? widget.white!.withValues(alpha: 0.9)
                            : widget.black!.withValues(alpha: 0.4)
                      : isSelectedDate
                      ? widget.white
                      : widget.black,
                ),
