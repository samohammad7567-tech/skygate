...
class BrowseNotificationsView extends GetView<BrowseNotificationsController> {
  ...
  final browseNotificationsController =
      Get.find<BrowseNotificationsController>();

  BrowseNotificationsView({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0.0,
        leading: TextButton(onPressed: () async {}, child: Icon(Icons.refresh)),
        actions: [
          TextButton(
            onPressed: () async {
