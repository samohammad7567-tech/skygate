...
class TripCard extends StatelessWidget {
  TripCard({super.key, this.flightCompanyLogo, this.tripNumber,
    this.tripDuration, this.departureCity, this.departureAirport,
    this.arrivalCity, this.arrivalAirport, this.firstWayLevel, this.tripPrice,
    this.departureTime, this.arrivalTime, this.index, this.isFirstWay,
    this.firstTransitCity, this.firstTransitAirport, this.secondTransitCity,
    this.secondTransitAirport});
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          ...
          border: Border.all(
            width: 1.5,
            color: myTripsAgendaController.checkTripCardBorderColor(index: index, isFirstWay: isFirstWay),
          )),
      child: Column(
        children: [
