              ...
              children: [
                ...
                GetBuilder<MyTripsAgendaController>(
                  ...
                  builder: (myTripsAgendaController) {
                    return HorizontalDaySelector(selectReturnTripPage: false);
                  },
                ),
                Text(
                  "اختيار رحلة الذهاب",
                ...
                GetBuilder<MyTripsAgendaController>(
                  ...
                  builder: (myTripsAgendaController) {
                    return SizedBox(
                      ...
                      child: CustomButton(
                        onTap:
                            myTripsAgendaController.selectedFirstWayCardIndex ==
                                -1
                            ? null
                            : () {
                                if (myTripsAgendaController.isOneWay == false) {
                                  final stringDate = myTripsAgendaController
                                      .returnDateController
                                      .text;
                                  final formattedDate = DateTime.tryParse(
                                    stringDate,
                                  );
                                  myTripsAgendaController.currentDate =
                                      formattedDate!;
                                  myTripsAgendaController.isTripWithinDate(
                                    true,
                                  );
