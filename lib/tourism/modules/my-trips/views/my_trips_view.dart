                ...
                if (myTripsController.tripsList.isEmpty) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return TripWidget(
                        departureCity:
                            myTripsController.tripsList[index].departure_place,
                        arrivalCity:
                        ...
                        filesList: myTripsController.tripsList[index].filesList,
                        index: index,
                        ticketID: myTripsController.tripsList[index].id
                            .toString(),
                        conditions:
                    ...
                    separatorBuilder: (BuildContext context, int index) {
                      return Padding(padding: EdgeInsets.only(bottom: 30.0.h));
                    },
