...
import 'package:skygate/tourism/modules/fingerprint_login/repository/fingerprint_login_repository.dart';
...
class FingerprintLoginController extends GetxController {
  ...
  Future<void> biometricsLogin({BuildContext? context}) async {
    (await fingerprintLoginRepository.fingerprintSignIn()).fold(
      (left) {
