...
class _PassportScannerViewState extends State<PassportScannerView> {
  ...
  void _onMRZDetected(String imagePath, MRZResult mrzResult) async {
    ...
    bool isPassportExpired = registerController.isExpiringWithinSixMonths(
      passportExpiry,
    );
    ...
    registerController.dobController.text = registerController.formatDate(
      mrzResult.birthDate,
    );
    registerController.passportNumberController.text = mrzResult.documentNumber;
    registerController.passportExpiryDateController.text = registerController
        .formatDate(mrzResult.expiryDate);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CameraView(mode: CameraMode.scan, onMRZDetected: _onMRZDetected),
    );
  }
}
