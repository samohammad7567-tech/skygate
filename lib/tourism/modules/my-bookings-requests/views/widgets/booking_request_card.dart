    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment:
                (myBookingsRequestsController.getPaymentButtonCondition(
                  status: status,
                ))
          ...
          Row(
            mainAxisAlignment:
                (myBookingsRequestsController.getRefundButtonCondition(
                  status: status,
                ))
                ? MainAxisAlignment.spaceBetween
                : MainAxisAlignment.center,
