          ...
          children: [
            ...
            GetBuilder(
              ...
              builder: (controller) {
                ...
                List<String> returnConditionsDisplay =
                    _mapConditionsToDisplay(returnConditions);
                    ...
                    GetBuilder<MyBookingsRequestsController>(
                      builder: (controller) {
                        return CustomButton(
                            ...
                            borderRadius: 30.0.r,
                            addShadow: false,
                            child: controller.acceptBookingConditionsStatus ==
                                    AcceptBookingConditionsStatus.loading
                                ? const SizedBox(
                                    width: 20,
                                    height: 20,
...
class ConditonWidget extends StatelessWidget {
  const ConditonWidget(
      {super.key, required this.conditions, required this.title});
