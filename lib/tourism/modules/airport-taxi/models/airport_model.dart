class AirportModel {
  ...
  AirportModel({this.id, this.name, this.iata_code, this.location,this.city, this.created_at, this.updated_at});
  ...
  factory AirportModel.fromJson(Map<String,dynamic> json) {
    return AirportModel(
        ...
        location: (json["location"] != null)? SkygateLocation.formJson(json["location"]): SkygateLocation(),
        city: json["city"] ?? "",
