...
class PromotionDetailsController extends GetxController {
  ...
  void onInit() {
    ...
    promotion = SharedClass.promotionsList.firstWhere((item) => item.id==promotionID);
  }
  ...
  Future<void> sendMessage({BuildContext? context}) async {
    ...
    String message = "أرجو التقدم بطلب حجز تذكرة للرحلة المعلنة من ${promotion.from} إلى ${promotion.to}";

    (await messagesRepository.sendMessage(msg: message, targetTeam: AppConfig.customerCareTeam.toString()))
        .fold((left) {
