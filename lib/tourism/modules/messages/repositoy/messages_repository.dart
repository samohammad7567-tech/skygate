...
import 'package:skygate/tourism/modules/messages/models/message_model.dart';
...
class MessagesRepository {
  ...
  Future<Either<Failure, BaseResponse<bool>>> sendMessage({
    String? msg,
    String? targetTeam,
    File? attach,
  }) async {
  ...
  Future<Either<Failure, BaseResponse<List<MessageModel>>>> getMessages({
    String? targetTeam,
  }) async {
    ...
    try {
      return right(
        await httpHelper.post(
          NetworkRoutesControl.getAllMessages,
