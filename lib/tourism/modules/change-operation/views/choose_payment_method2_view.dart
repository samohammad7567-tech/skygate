                ...
                if (changeOperationController.getPaymentMethodsStatus ==
                  ...
                  return Expanded(
                    child: ListView.separated(
                            ...
                            child: ExpansionTile(
                              ...
                              title: Text(
                                changeOperationController
                                    .paymentMethodsList[index].title!,
                                style: context.textTheme.titleMedium,
                              ),
                              subtitle: Text(
                                changeOperationController
                                    .paymentMethodsList[index].subtitle!,
                              ...
                              trailing: CachedNetworkImage(
                                ...
                                imageUrl: NetworkRoutesControl.imageUrl +
                                    changeOperationController
                                        .paymentMethodsList[index].image!,
                                width: 50.0.w,
                              ),
                              leading: Radio<String>(
                                value: changeOperationController
                                    .paymentMethodsList[index].title!,
                                groupValue: changeOperationController
                              ...
                              children: [
                                Text(
                                  changeOperationController
                                      .paymentMethodsList[index].details!,
                                  style: context.textTheme.titleSmall,
                                ),
                                Padding(
                        ...
                        itemCount: changeOperationController
                ...
                child: GetBuilder<ChangeOperationController>(
                    ...
                    builder: (changeOperationController) {
                      if (changeOperationController.payChangeRequestStatus ==
                        ...
                        return ErrorBanner(
                            failure: changeOperationController
                                .payChangeRequestFailure);
                      } else {
                        return Text(
                          "تأكيد طريقة الدفع",
