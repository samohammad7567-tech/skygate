      ...
      child: Row(
        children: [
          IconButton(
            ...
            onPressed: () => changeOperationController.navigateDays(
              -1,
              selectReturnTripPage,
            ),
          ),
          Expanded(
            child: Row(
              ...
              children: List.generate(3, (index) {
                ...
                final date = changeOperationController.currentDate.add(
                  Duration(days: dayOffset),
                );
                final weekday =
                    changeOperationController.arabicWeekdays[date.weekday - 1];
                final month =
                    changeOperationController.arabicMonths[date.month - 1];
          ...
          IconButton(
            ...
            onPressed: () =>
                changeOperationController.navigateDays(1, selectReturnTripPage),
          ),
        ],
      ),
    );
