...
class TripCard extends StatelessWidget {
  TripCard({
    ...
    this.index,
    this.isFirstWay,
    this.firstTransitCity,
    this.firstTransitAirport,
    this.secondTransitCity,
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          width: 1.5,
          color: changeOperationController.checkTripCardBorderColor(
            index: index,
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              CachedNetworkImage(imageUrl: flightCompanyLogo!, width: 75.0.w),
              Text(
                "$tripNumber",
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("assets/images/pngs/plane.png", width: 100.0.w),
              Text(
                "$arrivalTime",
                style: context.textTheme.titleSmall!.copyWith(
                  fontWeight: FontWeight.bold,
          ...
          Row(
            ...
            children: [
              ...
              Text("ابتداءً من", style: context.textTheme.titleSmall),
              Text(
                "$tripPrice",
                style: context.textTheme.titleMedium!.copyWith(
                  fontWeight: FontWeight.bold,
