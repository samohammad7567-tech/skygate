...
class GetRegularTripsRepository {
  ...
  Future<Either<Failure, BaseResponse<TripModel>>> getRegularTripByID({String? trip_id}) async {
  ...
  Future<Either<Failure, BaseResponse<List<TripModel>>>> getRegularTripsSameCompany({String? company_id}) async {
    Map<String, dynamic> requestBody = {};
