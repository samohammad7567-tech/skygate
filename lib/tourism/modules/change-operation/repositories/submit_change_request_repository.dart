...
class SubmitChangeRequestRepository {
  ...
  Future<Either<Failure, BaseResponse<bool>>> submitChangeRequest({
    required String? booking_request_number,
    required String? change_type,
    required String? first_way_trip_id,
    required String? return_trip_id,
  }) async {
