...
import 'package:skygate/tourism/modules/account/repository/account_repository.dart';
...
class AccountController extends GetxController {
  ...
  Future<void> logoutUser() async {
    ...
    (await accountRepository.logoutUser()).fold(
      (left) {
  ...
  Future<void> deleteUserProfile({BuildContext? context}) async {
    ...
    (await accountRepository.deleteUserProfile()).fold(
      (left) {
