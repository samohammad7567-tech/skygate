...
class VipTripCubit extends Cubit<VipTripState> {
  ...
  void setStartDate(DateTime value) {
    startDate = value;
    // `preferred_end_date` must be after the start, so an end date the new
    // start has overtaken is dropped rather than left to fail validation.
