...
enum LuggageTagStatus {
  ...
  /// The API types `status` as an array of undocumented strings, so this
  /// reads whatever came and treats anything not plainly disabled as live.
...
class LuggageTagModel {
  ...
  /// The card face prints the trailing digits large — "0247" on the design —
  /// while the row prints the whole serial.
