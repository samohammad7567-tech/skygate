...
/// "ابحث عن أنشطة" with the filter chip beside it.
///
/// Stateful only to own the field's controller; what was typed is handed to
/// the cubit, which is where the filtering happens.
