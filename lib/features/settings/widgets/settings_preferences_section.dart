...
/// "التفضيلات" — the one row here is the display language.
class SettingsPreferencesSection extends StatelessWidget {
  ...
  Future<void> _changeLanguage(BuildContext context) async {
    ...
    // The locale is EasyLocalization's to change and needs a context, so the
    // screen turns it and the cubit records the choice for the API header.
